...
const Pricing = () => {
  ...
  const config = {
    reference: `${ref}`,
    email: `extraile@africa.com `,
    amount: 40000,
    publicKey: "pk_live_830488c90483f0cdb7c589dc8da55be6a7e8e1a1",
  };
  ...
  const PaystackHookExample = () => {
    ...
    return (
      <div>
        ...
        onClick={() => {
          var r = confirm("You are required to pay a token of NGN 4000 for Identity verification and risk analysis. Click OK to continue");
          if(r === true){
 ...
 <center>
       ...
       <Text as="p">Pay with Paystack</Text>
       ...
       <Button  type="submit" variant="contained" color="primary" ><PaystackHookExample /></Button>
       </form>
